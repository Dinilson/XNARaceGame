...
namespace XNARaceGame {
    public class GraphicsManager {
        ...
        public void setViewportCoords (Vector2 coords) {
            int screenX = Math.Max(SCREEN_WIDTH / 2, Math.Min(1920 - (int)(SCREEN_WIDTH/2), (int)SCREEN_WIDTH/2));
            int screenY = Math.Max(SCREEN_HEIGHT / 2, Math.Min(1080 - (int)(SCREEN_HEIGHT/2) / 2, (int)SCREEN_HEIGHT / 2));
